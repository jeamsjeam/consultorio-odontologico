...
function CargarNavbar(pagina){
    document.getElementById("navbar").innerHTML = `
            <a class="navbar-brand p-1 text-white" href="#" style="background-color: #ba87ca; border-radius: 5px !important;">
                <img style="border-radius: 10px !important;" src="imagenes/IMG-20240810-WA0005.png" alt="" width="80" class="d-inline-block align-text-top">
                Consultorio
                </a>
